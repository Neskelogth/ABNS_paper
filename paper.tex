...
\section{Related Work}
	...
	In this section we will cover some related work to the topics that are of interest for this paper. In section \ref{featureExtractionSubSection} there is  an overview on 
	feature extraction methods, in section \ref{PrototypeContructionSubSection} there are prototype construction related work, and in section \ref{SimilarityJudgmentSubSection} there is an 
	outline of similarity judgment related work. 
	
	\subsection{Feature extraction related work}\label{featureExtractionSubSection}
	\subsection{Prototype construction related work}\label{PrototypeContructionSubSection}
	\subsection{Similarity judgment related work}\label{SimilarityJudgmentSubSection}
