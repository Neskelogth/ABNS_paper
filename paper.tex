...
\section{Background}
	...
	\subsection{Feature extraction}
		...
		\subsubsection{Deformable shape analysis}
			...
			A more sophisticated technique than the ones listed before is shape analysis. Deformable shape analysis, in particular, 
...
\bibitem{4} Pedro F. Felzenszwalb, ``Representation and Detection of Deformable Shapes'', IEEE Transactions on Pattern Analysis and Machine Intelligence, vol. 27, no. 2, pp. 208-220, Feb. 2005, doi: \url{https://doi.org/10.1109/TPAMI.2005.35} 
...
%\bibitem{b1} J. S. Owotogbe,T. S. Ibiyemi, and B. A. Adu, ``Edge Detection Techniques on Digital Images - A Review'', International Journal of Innovative Science and Research Technology, vol. 4, pp. 11, Nov. 2019
