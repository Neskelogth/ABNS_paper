...
\begin{document}
	...
	\section{Data Collection}
		...
		\subsection{Possible alternative to typicality values\label{sec:patv}}
			...
			method described in \ref{sec:typval}. % In case this type of data collection is used, the values of typicality should be also a question that asks the subjects to describe all the features that birds have in common 
			% with each other. This step will then be used for prototype construction.
