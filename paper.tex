...
\begin{document}
	...
	\section{Data Collection}
		...
		\subsection{Considerations about the survey}
			...
			while the alternative does not. Given the large number of images that should be used, though, it is not feasible to ask the subjects to rate the typicality value of all the images of the dataset. In fact, it is very likely 
